        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          >
            <h3 className="text-white font-bold text-xl mb-4">
              John Rush: <span className="text-gray-400 font-normal italic">
                &ldquo;I built SEObot because I needed it myself.
              </span>
            </h3>
            ...
            <div className="space-y-4 text-gray-400 italic">
              ...
              <p>
                With a mission to pioneer AI agents that produce helpful content for readers & bring SEO traffic to founders. Our users had 0.6b impressions & 15M clicks.&rdquo;
              </p>
            </div>
          </motion.div>
            ...
            <div className="space-y-3">
              {features.map((feature, index) => (
                <div key={index} className="flex items-start space-x-3">
                  <FaCheck className="text-orange-accent mt-1 flex-shrink-0" />
